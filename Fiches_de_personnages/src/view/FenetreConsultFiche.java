...
public class FenetreConsultFiche extends JFrame {
    ...
    private void loadFicheData() {
        nameField.setText(fichePersonnage.getName());
        ageField.setText(String.valueOf(fichePersonnage.getAge()));
        pvField.setText(String.valueOf(fichePersonnage.getPointDeVie()));
        bioTextArea.setText(fichePersonnage.getBiographie());
        updateStats(fichePersonnage.getStatistiques());
        updateCompetences(listToDefaultListModel(fichePersonnage.getCompetences()));
        updateEquipements(listToDefaultListModel(fichePersonnage.getEquipements()));
        updatePortrait();
    }
