...
public class FenetrePassword extends JFrame{
	...
	public FenetrePassword() {
        ...
        oldPwdLabel.setBounds(284, 420, 111, 30); // Position et taille de JLabel "Identifiant"
        contentPane.add(oldPwdLabel);
        
        oldPwdField.setBounds(284, 461, 194, 30); // Position et taille de JTextField pour l'identifiant
        contentPane.add(oldPwdField);
        
        //newPwdLabel.setForeground(new Color(139, 69, 19));
        newPwdLabel.setBounds(284, 514, 127, 20); // Position et taille de JLabel "Mot de passe"
        contentPane.add(newPwdLabel);
        
        newPwdField.setBounds(284, 545, 194, 30); // Position et taille de JTextField pour le mot de passe
        contentPane.add(newPwdField);
        
        confirmBoutton.setBounds(199, 650, 150, 30); // Position et taille du bouton de connexion
       ...
       // ControllerConnexion controller = new ControllerConnexion(this, oldPwdField, newPwdField, panelInfo);
